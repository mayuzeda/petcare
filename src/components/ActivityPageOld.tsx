...
const ActivityPage = () => {
    ...
    return (
        <PetLayout
            ...
            showHelp={true}
            showBackButton={true}
            title={`Atividades de ${selectedPet.name}`}
        >
            <div className="min-h-screen flex flex-col pb-20">
                <main className="flex-1 container mx-auto p-2 md:p-3">
                    <div className="mb-4">
                        <ToggleGroup type="single" value={timeRange} onValueChange={handleTimeRangeChange} className="p-1 rounded-lg flex justify-center">
