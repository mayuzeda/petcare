  ...
  return (    
    <div className="min-h-screen flex flex-col pb-20">
      <header className="flex items-center justify-between p-3 bg-white shadow-sm">
        <div className="flex items-center">          <BackButton />
          <h1 className="text-lg font-bold ml-2">Vermífugos</h1>
        </div>
          ...
          <div className="bg-white rounded-lg shadow p-3">
            {antiparasiticEvents.length > 0 ? (
              ...
              <div className="text-center py-6 text-gray-500">
                ...
                <p className="text-sm">Nenhum vermífugo registrado para {selectedPet.name}</p>
                <Button 
                  variant="outline" 
